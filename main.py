...
#Оскільки програма виконується досить довго,я зробив 10 повторень замість 100,
#але Ви можете обрати потрібну кількіть, змінивши "repeat" в наступному рядку
repeat=10
...
f_x1_x2_x3 = [8.8, 8, 5.4, 8, 3.4, 0.9, 3.5, 0.3, 0.2, 0.2, 2.9]
...
timee = (time.time_ns() - start_time)* 10**(-9)
print("Час роботи: ", timee)
av_time=timee/repeat
print("Середній час одного проходження:", av_time)
